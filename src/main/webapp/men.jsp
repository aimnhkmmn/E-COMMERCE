...
<%
    ...
    for (Product p : allProducts) {
        if ("Men".equalsIgnoreCase(p.getCategory()) && (selectedType == null || selectedType.isEmpty() || selectedType.equalsIgnoreCase(p.getType()))) {
            filteredList.add(p);
        }
    }
    ...
    <div class="shop-container">
        <aside class="shop-sidebar">
            <div class="filter-group">
                <h3>Category</h3>
                <a href="men.jsp">All</a>
                <a href="men.jsp?type=Running">Running</a>
                <a href="men.jsp?type=Casual">Casual</a>
                <a href="men.jsp?type=Basketball">Basketball</a>
            </div>
        </aside>
