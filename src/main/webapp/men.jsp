...
<%
    ...
    List<Product> filteredList = allProducts.stream()
        ...
        .filter(p -> "Men".equalsIgnoreCase(p.getCategory()))
        // Filter by Type (Running, Casual, etc.)
        .filter(p -> selectedType == null || selectedType.isEmpty() || selectedType.equalsIgnoreCase(p.getType()))
        // Filter by Brand (Nike, Adidas, etc.)
...
<head>
    <meta charset="UTF-8">
    <title>Men's Shoes - FootWearHub</title>
...
<main class="content-wrapper">
    <div class="shop-container">
        <aside class="shop-sidebar">
            <form id="filterForm" method="get" action="men.jsp">
                <div class="filter-group">
                    <h3>Category</h3>
                    <div class="type-filter">
                        <a href="men.jsp" class="<%= selectedType == null ? "active" : "" %>">All</a>
                        <a href="men.jsp?type=Running" class="<%= "Running".equals(selectedType) ? "active" : "" %>">Running</a>
                        <a href="men.jsp?type=Casual" class="<%= "Casual".equals(selectedType) ? "active" : "" %>">Casual</a>
                        <a href="men.jsp?type=Basketball" class="<%= "Basketball".equals(selectedType) ? "active" : "" %>">Basketball</a>
                    </div>
                </div>
                <div class="filter-group">
                    <h3>Brand</h3>
        ...
        <main class="shop-content">
            <div class="shop-header">
                ...
                <div class="sort-dropdown">
                    <form id="sortForm" method="get" action="men.jsp">
