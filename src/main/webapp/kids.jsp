...
<%
    ...
    List<Product> filteredList = allProducts.stream()
        .filter(p -> "Kids".equalsIgnoreCase(p.getCategory()))
...
<main class="content-wrapper">
    <div class="shop-container">
        <aside class="shop-sidebar">
            <form id="filterForm" method="get" action="kids.jsp">
                <div class="filter-group">
                    <h3>Category</h3>
                    <div class="type-filter">
                        <a href="kids.jsp" class="<%= selectedType == null ? "active" : "" %>">All</a>
                        <a href="kids.jsp?type=Running" class="<%= "Running".equals(selectedType) ? "active" : "" %>">Running</a>
                        <a href="kids.jsp?type=Casual" class="<%= "Casual".equals(selectedType) ? "active" : "" %>">Casual</a>
                        <a href="kids.jsp?type=Basketball" class="<%= "Basketball".equals(selectedType) ? "active" : "" %>">Basketball</a>
                    </div>
                </div>
                <div class="filter-group">
                    <h3>Brand</h3>
        ...
        <main class="shop-content">
            <div class="shop-header">
                ...
                <div class="sort-dropdown">
                    <form id="sortForm" method="get" action="kids.jsp">
